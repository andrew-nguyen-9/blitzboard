...
|-------|--------|------|--------------|--------|
| [v2.0](v2.0-foundation.md) | `v2` (+ `v2.0-*`) | Foundation & De-Andrew-ification | #8, workflow, tokens, a11y/motion scaffold | Planned |
| [v2.1](v2.1-design-homepage.md) | `v2.1-*` | Design System & Homepage revamp | #1 | Planned |
