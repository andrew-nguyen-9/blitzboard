...
- state: running
- phase: C00 independent baseline
...
- blockers: `C00-claude.md` has not been supplied; frontend harness exit remains non-green
...
- next action: await `C00-claude.md`, reconcile it against the frozen blind review, and issue verdict
