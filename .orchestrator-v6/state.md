...
- state: running
- phase: C01 independent adversarial preparation
...
- next action: await amended C01 production checkpoint; audit original coverage/contingency scope
  plus player-unit, redraft-age, search-rank, and superflex-replacement correctness
